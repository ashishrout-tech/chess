...
const After = (props: componentProps) => {
    ...
    return (
        <div className="flex justify-center items-center">
            <Image placeholder='empty' priority={false} className=" h-[32rem] mt-24 sm:h-96 sm:mt-10 w-96 contrast-75 saturate-200 z-0 absolute" width={384} height={384} src={"/board.jpeg"} alt="board" unoptimized={true} />
            <div className=" h-[32rem] mt-24 sm:h-96 sm:mt-10 w-96 z-10 flex flex-wrap ">
                {
                    arr.map(ele => {
                        if (ele.src == ".") {
