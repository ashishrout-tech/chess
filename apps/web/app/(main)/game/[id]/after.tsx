    ...
    return (
        <>
            <div className=" select-none flex justify-center items-center">
                <Image placeholder='empty' priority={false} className=" h-[32rem]  sm:h-96  w-96 contrast-75 saturate-200 absolute" width={384} height={384} src={"/board.jpeg"} alt="board" unoptimized={true} />
